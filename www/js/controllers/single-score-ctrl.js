...
angular.module("highScoreApp").controller("singleScoreCtrl", function ($scope, $stateParams, highScoreFactory, $ionicModal, $ionicScrollDelegate, $location, messageFactory) {
  ...
  $scope.options = {
    axes: {
      x: {
        ...
        labelFunction: function labelFunction(date) {
    ...
    tooltip: {
      mode: "scrubber",
      formatter: function formatter(x, y, series) {
        return y;
      }
    },
    drawLegend: false,
