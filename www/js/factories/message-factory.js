...
angular.module("highScoreApp").factory("messageFactory", function ($timeout) {
  /***
  ...
  function messageText(message) {
    ...
    if (typeof message === "object") {
      ...
      if (message.data && message.data.userMessage) {
        return message.data.userMessage;
  ...
  return {
    show: function show(type) {
      ...
      return currentPromise = $timeout(function () {}, type === "error" ? 3000 : 1000);
    },
